...
namespace MyNoteMarketPlace.Controllers
{
    ...
    public class AdminNotesController : Controller
    {
        ...
        public ActionResult NotesUnderReview(int? member, int? seller, string search, string sort, int? page )
        {
            ...
            IEnumerable<NotesUnderReviewModel> notelist;
            ...
            var result = new List<NotesUnderReviewModel>();
            result = notelist.ToList();

            return View(result.ToList().AsQueryable().ToPagedList(page ?? 1, 5));
        }

        // sorting for notes under reviews
        private IEnumerable<NotesUnderReviewModel> SortTableNotesUnderReview(string sort, IEnumerable<NotesUnderReviewModel> table)
        {
            switch (sort)
            {
                case "Title_Asc":
           ...
           // THIS 3 METHODS WORKS FOR 3 BUTTONS APPROVE,REJECTED AND IN REVIEW. 
        ...
        public ActionResult PublishedNotes(int? member, int? seller, string search, string sort, int? page)
        {
            ...
            IEnumerable<PublishedNoteModel> notelist;
            ...
            var result = new List<PublishedNoteModel>();
            result = notelist.ToList();
        ...
        private IEnumerable<PublishedNoteModel> SortTablePublishedNotes(string sort, IEnumerable<PublishedNoteModel> table)
        {
            switch (sort)
            {
                case "Title_Asc":
        ...
        public ActionResult DownloadedNotes(int? selectednote, int? member, int? note, int? seller, int? buyer, string search, string sort, int? page )
        {
            ...
            IEnumerable<DownloadedNotesModel> notelist;
            ...
            var result = new List<DownloadedNotesModel>();
            result = notelist.ToList();
        ...
        private IEnumerable<DownloadedNotesModel> SortTableDownloadedNotes(string sort, IEnumerable<DownloadedNotesModel> table)
        {
            switch (sort)
            {
                case "Title_Asc":
        ...
        public ActionResult RejectedNotes(int? seller, string search, string sort, int? page )
        {
            ...
            IEnumerable<RejectedNotesModel> notelist = from notes in context.SellerNotes
                                                           join sellers in context.Users on notes.SellerID equals sellers.ID
            ...
            var result = new List<RejectedNotesModel>();
            result = notelist.ToList();
        ...
        private IEnumerable<RejectedNotesModel> SortTableRejectedNotes(string sort, IEnumerable<RejectedNotesModel> table)
        {
            switch (sort)
            {
                case "Title_Asc":
