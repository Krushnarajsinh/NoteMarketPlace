...
namespace MyNoteMarketPlace.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        private IEnumerable<AdminDashboardModel.PublishedNotesList> SortTableDashboard(string sort, IEnumerable<AdminDashboardModel.PublishedNotesList> table)
        {
            switch (sort)
            {
                case "Title_Asc":
        ...
        public void UnpublishNoteTemplate(string remark, Users seller, SellerNotes note)
        {
            ...
            body = "Hello " + seller.FirstName + " " + seller.LastName + "," +
        ...
        public ActionResult NoteDetail(int noteid)
        {
            ...
            IEnumerable<UserReviewsModel> reviews = from review in context.SellerNotesReviews
            ...
            AdminNoteDetailModel notesdetail = new AdminNoteDetailModel();
